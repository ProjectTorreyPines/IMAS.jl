...
dyexp["core_profiles.profiles_1d[:].j_non_inductive"] =
    (; dd, profiles_1d, _...) -> total_sources(dd.core_sources, profiles_1d; time0=profiles_1d.time, exclude_indexes=[7, 409], fields=[:j_parallel]).j_parallel # no ohmic or time_dependent
