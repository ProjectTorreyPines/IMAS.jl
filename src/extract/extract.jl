...
function update_ExtractFunctionsLibrary!()
    ...
    ExtractLibFunction(:currents, :ramp_flux, "Vs", dd -> @ddtime(dd.build.flux_swing.rampup))
    ExtractLibFunction(:currents, :flattop_flux, "Vs", dd -> @ddtime(dd.build.flux_swing.flattop))
    ExtractLibFunction(:currents, :pf_flux, "Vs", dd -> @ddtime(dd.build.flux_swing.pf))
