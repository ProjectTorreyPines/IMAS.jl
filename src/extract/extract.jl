...
function update_ExtractFunctionsLibrary!()
    ...
    ExtractLibFunction(:transport, :τe, "s", dd -> tau_e_thermal(dd; ignore_radiation=false))
    ExtractLibFunction(:transport, :τe_exp, "s", dd -> tau_e_thermal(dd; ignore_radiation=true))
    ExtractLibFunction(:transport, :H98y2, "-", dd -> EFL[:τe](dd) / tau_e_h98(dd; ignore_radiation=false))
    ExtractLibFunction(:transport, :H98y2_exp, "-", dd -> EFL[:τe_exp](dd) / tau_e_h98(dd; ignore_radiation=true))
    ExtractLibFunction(:transport, :Hds03, "-", dd -> EFL[:τe](dd) / tau_e_ds03(dd; ignore_radiation=false))
    ExtractLibFunction(:transport, :Hds03_exp, "-", dd -> EFL[:τe_exp](dd) / tau_e_ds03(dd; ignore_radiation=true))
