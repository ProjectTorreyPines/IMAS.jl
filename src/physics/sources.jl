...
function collisional_exchange_source!(dd::IMAS.dd)
    ...
    source = resize!(dd.core_sources.source, :collisional_equipartition; wipe=false, allow_multiple_matches=true)
...
function ohmic_source!(dd::IMAS.dd)
    ...
    if j_ohmic !== missing
        ...
        source = resize!(dd.core_sources.source, :ohmic; wipe=false, allow_multiple_matches=true)
...
function bootstrap_source!(dd::IMAS.dd)
    ...
    if j_bootstrap !== missing
        source = resize!(dd.core_sources.source, :bootstrap_current; wipe=false, allow_multiple_matches=true)
