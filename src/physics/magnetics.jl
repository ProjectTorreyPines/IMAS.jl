...
"""
function field!(probes::IMAS.IDSvector{IMAS.magnetics__b_field_pol_probe{T}}, PSI_interpolant::FI.AbstractInterpolant, time0::Float64) where {T<:Real}
    for probe in probes
...
"""
    flux!(loops::IMAS.IDSvector{IMAS.magnetics__flux_loop{T}}, PSI_interpolant::FI.AbstractInterpolant, time0::Float64) where {T <: Real}

Calculates synthetic flux loops data
"""
function flux!(loops::IMAS.IDSvector{IMAS.magnetics__flux_loop{T}}, PSI_interpolant::FI.AbstractInterpolant, time0::Float64) where {T<:Real}
    for loop in loops
