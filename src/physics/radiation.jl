...
function bremsstrahlung_source!(dd::IMAS.dd)
    ...
    source = create!(dd.core_sources.source, :bremsstrahlung)
...
function synchrotron_source!(dd::IMAS.dd; wall_reflection_coefficient=0.8)
    ...
    source = create!(dd.core_sources.source, :synchrotron_radiation)
...
function line_radiation_source!(dd::IMAS.dd)
    ...
    source = create!(dd.core_sources.source, :line_radiation)
