...
function update_ExtractFunctionsLibrary!()
    ...
    ExtractLibFunction(:sources, :Pcharge, "MW", dd -> fusion_plasma_power(dd) / 1E6)
    ExtractLibFunction(:sources, :Pohm, "MW", dd -> total_power_source(IMAS.ohmic_source!(dd).profiles_1d[])/ 1E6)
    ExtractLibFunction(:sources, :Pheat, "MW", dd -> @ddtime(dd.summary.heating_current_drive.power_launched_total.value) / 1E6
    + fusion_plasma_power(dd) / 1E6 + total_power_source(IMAS.ohmic_source!(dd).profiles_1d[])/1E6)
    ...
    ExtractLibFunction(:exhaust, :qpol, "MW/m^2", dd -> q_pol_omp_eich(dd) / 1E6)
    ExtractLibFunction(:exhaust, :qpar, "MW/m^2", dd -> q_par_omp_eich(dd) / 1E6)
