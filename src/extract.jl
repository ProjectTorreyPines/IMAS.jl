...
function update_ExtractFunctionsLibrary!()
    ...
    ExtractLibFunction(:geometry, :Volume, "m^3", dd -> dd.equilibrium.time_slice[].profiles_1d.volume[end])
    ExtractLibFunction(:geometry, :Surface, "m^2", dd -> dd.equilibrium.time_slice[].profiles_1d.surface[end])
    ...
    ExtractLibFunction(:bop, :TBR, "-", dd -> @ddtime(dd.blanket.module[].time_slice[].tritium_breeding_ratio))
