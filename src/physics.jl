...
@enum BuildLayerShape::Int _offset_ _negative_offset_ _convex_hull_ _princeton_D_exact_ _princeton_D_ _princeton_D_scaled_ _rectangle_ _double_ellipse_ _circle_ellipse_ _triple_arc_ _miller_ _silo_ _racetrack_ _undefined_
